...
private:
    ...
    int count_neighbors(size_t const row, size_t const col)
    {
        ...
        {
            return count_alive(cell(columns - 2, 0),
                               cell(columns - 2,1),
                               cell(columns - 1, 1));
        }
        ...
        if(row == rows - 1 && col == 0)
        {
            return count_alive(cell( 0, rows - 2),
                               cell(1,rows - 2),
                               cell(1, rows - 1));
        }
        ...
        {
            return count_alive(cell( col - 1, 0),
                               cell(col - 1,1),
                               cell(col, 1),
                               cell(col + 1, 1),
                               cell( col + 1, 0));
        ...
        {
            return count_alive(cell( col - 1, row),
                               cell(col - 1,row - 1),
                               cell(col, row - 1),
                               cell(col + 1, row - 1),
                               cell( col + 1, row));
        ...
        {
            return count_alive(cell( 0, row - 1),
                               cell(1,row - 1),
                               cell(1, row),
                               cell(1, row + 1),
                               cell( 01, row + 1));
        ...
        {
            return count_alive(cell( col, row - 1),
                               cell(col - 1 ,row - 1),
                               cell(col - 1, row),
                               cell(col - 1, row + 1),
                               cell( col, row + 1));
        ...
        return count_alive(cell( col - 1, row - 1),
                           cell(col, row - 1),
                           cell(col + 1, row - 1),
                           cell(col + 1, row),
                           cell(col + 1, row + 1),
