//
// Created by Oleksandr Demnychenko on 25.12.2024.
//
#include "iostream"
#include "random"
#include "map"
...
protected:
    ...
    virtual int next_random(unsigned const year, unsigned const month, unsigned const day)
    {
...
class northerial_social_number_generator final: public social_number_generator
{
public:
    northerial_social_number_generator():
...
public:
    ...
    {
        generators["northeria"] = std::make_unique<northerial_social_number_generator>();
